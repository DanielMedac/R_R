...
public class AdUsuario {
	...
	public AdUsuario(String nombre, String apellido, String dni, String contrasena, String tlf, String direccion) {
	...
	public void Actualizar(String nombre, String apellido, String dni, String contrasena, String tlf, String direccion) {
		this.nombre = nombre;
		this.apellido = apellido;
		this.dni = dni;
		this.contrasena = contrasena;
